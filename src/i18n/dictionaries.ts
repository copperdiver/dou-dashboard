...
const ru = {
  ...
  /* Связь с источником: сводится из трафика насосов, не из своего пинга. */
  source: {
    title: 'Связь с источником',
    reachable: 'Источник отвечает',
    unreachable: 'Источник недоступен',
    degraded: 'Отвечает с перебоями',
    lastSuccess: 'Последний успешный индекс',
    lastFailure: 'Последняя ошибка:',
    cooldown: 'Пауза после отказа',
    budget: 'Запросов за сутки',
    failedDays: 'Дней требуют сброса',
    pendingPages: 'Страниц ждут загрузки',
    check: 'Проверить связь',
    probeNever: 'Проверка вручную не запускалась',
    probeAt: 'Проверка',
...
const en: EnglishDictionary = {
  ...
  source: {
    ...
    reachable: 'Source responds',
    unreachable: 'Source unreachable',
    degraded: 'Responds intermittently',
    lastSuccess: 'Last successful index',
    lastFailure: 'Last error:',
    cooldown: 'Cooldown after refusal',
    budget: 'Requests today',
    failedDays: 'Days needing a reset',
    pendingPages: 'Pages awaiting fetch',
    check: 'Check connectivity',
    probeNever: 'No manual check has been run',
    probeAt: 'Checked',
